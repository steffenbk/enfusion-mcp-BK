...
1. **Understand the project** — Use **project_browse** and **project_read** to explore:
...
2. **Research the API** — Use **api_search** to find relevant classes and methods.

3. **Plan the changes** — Determine what to modify, create, or remove.

4. **Implement** — Make all modifications:
...
5. **Validate** — Use **mod_validate** to check for issues.

6. **Workbench Setup** (MANDATORY — do not skip, do not tell the user to do this):
...
7. **wb_play** — Test the changes in-game. Use **wb_stop** to return to editor.

8. Summarize what changed and how the mod works now.
